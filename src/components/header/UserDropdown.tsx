...
export default function UserDropdown() {
  ...
  const emailPrefix = user?.email?.split("@")[0] || "A";
  const avatarBg = "bg-gray-300 text-gray-700";
  ...
  return (
    <div className="relative">
      ...
      >
        <span
          className={`mr-3 flex h-11 w-11 items-center justify-center overflow-hidden rounded-full ${avatarBg} font-medium`}
        >
      ...
      >
        ...
        <Button
          ...
          className="flex items-center justify-between px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
